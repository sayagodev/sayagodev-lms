      ...
      <div className="order-1 lg:col-span-2">
        ...
        <div className="mt-12 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div>
              {course.chapters.length} capitulos |{" "}
          ...
          <Card className="py-0">
            <CardContent className="p-6 space-y-6">
              ...
              <div className="mb-6 space-y-3 rounded-lg bg-muted p-4">
                <h4 className="font-medium">Qué obtendras:</h4>
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Duración del curso</p>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Nivel del curso</p>
                      <p className="text-sm text-muted-foreground">
                        {course.level}
                      </p>
                    </div>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Categoría del curso</p>
                      <p className="text-sm text-muted-foreground">
                        {course.category}
                      </p>
                    </div>
                ...
                <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium">Lecciones totales</p>
                      <p className="text-sm text-muted-foreground">
                        {course.chapters.length} capitulos |{" "}
                        {course.chapters.reduce(
                          (total, chapter) => total + chapter.lessons.length,
              ...
              <div className="mb-6 space-y-3">
                ...
                <ul className="space-y-2">
                  ...
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Acceso por celular y computadora</span>
                  </li>
                  <li className="flex items-center gap-2 text-sm">
                    <div className="rounded-full bg-green-500/10 text-green-500 p-1">
                      <CheckIcon className="size-4" />
