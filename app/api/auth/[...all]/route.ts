  ...
  if (decision.isDenied()) {
    if (decision.reason.isRateLimit()) {
      ...
      if (decision.reason.emailTypes.includes("INVALID")) {
        message =
          "Correo electrónico formato inválido. ¿Hay un error de tipeo?";
      } else if (decision.reason.emailTypes.includes("DISPOSABLE")) {
        message = "No permitimos direcciones de correo electrónico temporales.";
      } else if (decision.reason.emailTypes.includes("NO_MX_RECORDS")) {
        message =
          "El dominio de correo electrónico no tiene un registro MX. ¿Hay un error de tipeo?";
      } else {
